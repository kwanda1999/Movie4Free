...
namespace Movie4Free.Controllers
{
    public class MoviesController : Controller
    {
        private readonly Movie4FreeContext _context;

        public MoviesController(Movie4FreeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString)
        {
            ...
            {
                return Problem("Entity set 'Movie4FreeContext.Movie' is null.");
            }
            ...
            {
                movies = movies.Where(x => x.Genre != null && x.Genre == movieGenre);
            }
